        ...
        <div className="prose dark:prose-invert max-w-none space-y-8">
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              By accessing or using PawVault, you agree to be bound by these Terms of Service. If you do not agree with these terms, please do not use our platform. We reserve the right to modify these terms at any time, and your continued use constitutes acceptance of any changes.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Payouts are processed according to the payout schedule displayed in your creator dashboard. PawVault handles payment collection and disbursement. Creators are responsible for their own tax obligations.
                </p>
              </div>
              <div>
                <h3 className="text-xl font-semibold mb-2">Prohibited Content</h3>
                <p className="text-muted-foreground leading-relaxed">
                  You may not upload copyrighted material without permission, malicious code, illegal content, or material that infringes on others rights. We reserve the right to remove content that violates these terms.
                </p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Customers receive a license to use purchased digital products according to the license terms specified by the creator. Most licenses are for personal or commercial use as defined by the creator. Resale or redistribution of purchased files is prohibited unless explicitly permitted by the creator.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Refunds are handled according to our Refund Policy. Refund requests can be submitted through your purchase history. Repeated refund requests may result in account restrictions.
            </p>
          </section>
