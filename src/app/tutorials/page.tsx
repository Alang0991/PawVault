...
const tutorials = [
  ...
  },
  {
    ...
    steps: [
      ...
      "Upload a thumbnail and gallery images via the drag-and-drop media uploader.",
      "Add your downloadable files (ZIP, RAR, source archives, etc.).",
      "Set pricing — regular price, optional sale price with a date range, or mark it Free.",
      "Configure the license type and publish. Your product is now live and discoverable.",
    ],
  },
  {
    icon: KeyRound,
    ...
    steps: [
      ...
      "Keys are revoked on refund/chargeback, which immediately blocks downloads.",
    ],
  },
  {
    icon: CreditCard,
    ...
    minutes: 6,
    steps: [
      "Open Creator → Payouts to review your earnings and payout method.",
      "PawVault is the merchant of record: we collect and remit VAT/sales tax for you.",
      "Commissions are 15% standard, 12% verified, 10% premium partners.",
      "Payouts run monthly on the 15th with a $50 minimum threshold.",
      "Track every payout and tax record from your creator analytics dashboard.",
    ],
  },
  {
    icon: Sparkles,
    title: "Optimize a listing for discovery",
    level: "Advanced",
    minutes: 12,
    steps: [
      "Use a clear, searchable title that names the asset and its compatibility (e.g. “PC + Quest VRChat Avatar”).",
      "Add 5–10 specific tags (style, engine, platform) so filters can surface it.",
      "Upload a high-quality thumbnail and a preview video — these drive click-through.",
      "Set a competitive sale price with a limited-time discount to boost ranking.",
      "Pin the product as featured on your storefront and link it from collections.",
    ],
  },
  {
    icon: ShieldCheck,
    ...
    steps: [
      ...
      "Mark trusted devices to reduce prompts on hardware you use often.",
    ],
  },
]
