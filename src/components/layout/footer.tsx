        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><Link href="/browse" className="hover:text-foreground transition-colors">Browse Assets</Link></li>
              <li><Link href="/shops" className="hover:text-foreground transition-colors">Browse Shops</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><Link href="/creator/dashboard" className="hover:text-foreground transition-colors">Dashboard</Link></li>
              <li><Link href="/creator/products" className="hover:text-foreground transition-colors">My Assets</Link></li>
              <li><Link href="/creator/payouts" className="hover:text-foreground transition-colors">Payouts</Link></li>
              <li><Link href="/store/create" className="hover:text-foreground transition-colors">Open Shop</Link></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link href="/copyright" className="hover:text-foreground transition-colors">Copyright / DMCA</Link></li>
            </ul>
          </div>
        </div>
